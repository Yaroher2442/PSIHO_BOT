...
def backward(old_orm, new_orm):
    answersstatistic = new_orm['answersstatistic']
    return [
        # Apply default value '' to the field answersstatistic.answer
        answersstatistic.update({answersstatistic.answer: ''}).where(answersstatistic.answer.is_null(True)),
    ]
